...
void Student::getInput(bool isNew)
{
	...
	if (isNew || promptToChange("the student's presentation grade"))
	{
		...
		while (!valueSet)
		{
			try
			{
				cout << "Enter the grade value between 0 to 1 for Grade Presentation (Ex. .9 = 90):\n";
				getline(cin, line);
	...
	if (isNew || promptToChange("the student's essay 1 grade"))
	{
		...
		while (!valueSet)
		{
			try
			{
				cout << "Enter the grade value between 0 to 1 for Essay 1 Grade (Ex. .9 = 90):\n";
				getline(cin, line);
	...
	if (isNew || promptToChange("the student's essay 2 grade"))
	{
		...
		while (!valueSet)
		{
			try
			{
				cout << "Enter the grade value between 0 to 1 for Essay 2 (Ex. .9 = 90): \n";
				getline(cin, line);
	...
	if (isNew || promptToChange("the student's term project grade"))
	{
		...
		while (!valueSet)
		{
			try
			{
				cout << "Enter the grade value between 0 to 1 for Term Project Grade (Ex. .9 = 90):\n";
				getline(cin, line);
